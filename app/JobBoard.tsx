...
export default function JobBoard({ jobs, notice }: { jobs: Job[]; notice?: string | null }) {
  ...
  return <main dir="rtl">
    ...
    <aside className="creditBar"><span>لا تنسونا ووالدينا من دعائكم</span><a href="https://www.tiktok.com/@vlogqueenn" target="_blank" rel="noopener noreferrer"><TikTokIcon /><b dir="ltr">@vlogqueenn</b></a></aside>
