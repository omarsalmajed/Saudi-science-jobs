...
export default function JobBoard({ jobs, notice }: { jobs: Job[]; notice?: string | null }) {
  ...
  return <main dir="rtl">
    ...
    <footer><div className="brand"><span className="brandMark">س</span><span><b>وظائف العلوم</b><small>Saudi Science Jobs</small></span></div><p>منصة مستقلة لجمع الوظائف العلمية في المملكة العربية السعودية.</p><div className="footerEnd"><span>© 2026</span><Link className="adminLink" href="/admin">دخول الإدارة</Link><small className="footerPrayer">لا تنسونا ووالدينا من دعائكم<br />هينار - @vlogqueenn</small></div></footer>
  </main>;
}
